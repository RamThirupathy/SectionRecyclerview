...
public abstract class SectionListener {
    ...
    private void initHeaderSticker() {
        mHeaderView.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                switch (event.getAction()) {
                    case MotionEvent.ACTION_MOVE:
                        ...
                        if (!isLongPressEnabled || mCurrentHeaderSection.getSectionPosition() == 0) {
                            return false;
                        }
                        if (firstHold) {
                            firstHold = false;
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                switch (event.getAction()) {
                    case MotionEvent.ACTION_MOVE:
                        ...
                        if (!isLongPressEnabled || mCurrentFooterSection.getSectionPosition() == getLastSection().getSectionPosition()) {
                            return false;
                        }
                        if (firstHold) {
                            setCloneBottom();
                        ...
                        if (newY < 0 && newY >= (recyclerViewHt)) {
                            ...
                            } else if (newY >= (-view.getHeight()) && mCurrentFooterSection.getSectionPosition() < getLastSection().getSectionPosition()) {
